...
class ScoreData:
    def __init__(self, source_iceberg, destination_iceberg, min_penguins_for_occupy, max_penguins_can_be_sent,
                 spare_penguins, score,
        ...
        self.__spare_penguins = spare_penguins
        self.__score = score
