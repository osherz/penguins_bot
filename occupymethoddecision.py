...
class OccupyMethodDecision:
    ...
    def pick_occupy_method(self, source_iceberg, destination_iceberg):
        ...
        if utils.is_enemy(self.__game, owner_if_no_action_will_made):
        ...
        elif utils.is_me(game, owner_if_no_action_will_made):
            # If the iceberg will belong ot me,
            # we want to think about sending some support.
            min_penguins_to_send_for_occupy = __calc_penguins_to_send_for_support(source_iceberg)
...
def __calc_penguins_to_send_for_support(source_iceberg):
    """
